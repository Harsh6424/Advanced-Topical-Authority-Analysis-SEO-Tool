...
import type { CategorizedUrlData, CategorySummary } from '../types';
import { exportToExcel } from '../utils/dataUtils';
import { DownloadIcon, InsightIcon, RestartIcon, BackIcon } from './Icons';
...
const ResultsTable: React.FC<ResultsTableProps> = ({ categorizedData, summaryData, onGetInsights, onReset, onGoBack }) => {

  const handleDownload = () => {
    exportToExcel(categorizedData, summaryData);
  };
  ...
  return (
    <div className="space-y-12">
      <div>
        <h2 className="text-2xl font-semibold mb-4 text-white">Step 2: Analysis & Review</h2>
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
            <button
              onClick={onGoBack}
              className="flex-1 sm:flex-none inline-flex items-center justify-center px-6 py-3 border border-gray-600 text-base font-medium rounded-md text-gray-200 bg-gray-700 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 focus:ring-offset-gray-800 transition-colors"
            >
